        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/reservation-room-details/create') }}" class="btn btn-custom-primary btn-sm" title="Add New ReservationRoomDetail">
                                ...
                                @foreach($reservationroomdetails as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::open([
                                                'method' => 'DELETE',
                                                'url' => ['/admin/reservation-room-details', $item->id],
