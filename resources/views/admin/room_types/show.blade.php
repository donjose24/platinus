...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="{{ url('/admin/room_types/' . $roomtype->id . '/edit') }}" title="Edit RoomType"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
        {!! Form::open([
            'method'=>'DELETE',
